...
public class FastDfsController {
    ...
    public AjaxResult upload(MultipartFile file){
        ...
        try {
            ...
            return AjaxResult.getAjax().setSuccess(true).setMessage("上传成功!").setObject(upload);
        } catch (Exception e) {
            e.printStackTrace();
            return AjaxResult.getAjax().setSuccess(false).setMessage("上传失败!"+e.getMessage());
        }
    }
    ...
    public AjaxResult delete(String fileId){
        ...
        try {
            ...
            e.printStackTrace();
            return AjaxResult.getAjax().setSuccess(false).setMessage("删除失败!"+e.getMessage());
        }
